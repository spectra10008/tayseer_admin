...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">انشاء طلب تمويل</h2>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">انشاء طلب تمويل</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form form-vertical" action="/panel-admin/form-requets" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="اسم مستفيد" value="{{ old('name') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('age') is-invalid @enderror" name="age" placeholder="العمر" value="{{ old('age') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('id_number') is-invalid @enderror" name="id_number" placeholder="الرقم الوطني" value="{{ old('id_number') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select name="social_situation_id" class="form-control @error('social_situation_id') is-invalid @enderror" required>
                                                    ...
                                                    <option value="{{$status->id}}"@selected($status->id == old('social_situation_id'))>{{$status->situation_desc}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('children_no') is-invalid @enderror" name="children_no" placeholder="عدد الأولاد" value="{{ old('children_no') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" placeholder="العنوان" value="{{ old('address') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <hr>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="notes" class=" ckeditor form-control @error('notes') is-invalid @enderror">{{ old('notes') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <hr>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="autocomplete" id="autocomplete"
                                                    class="form-control" placeholder="الموقع" value="{{old('autocomplete')}}">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
