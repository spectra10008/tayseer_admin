                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                            <table class="table zero-configuration">
                                ...
                                <tbody>
                                    @foreach ($users->where('id','!=',auth()->guard('mfis_providers')->user()->id) as $key => $user)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>
                                            ...
                                            event.preventDefault();}"><i
                                                ...
                                                <form id="delete-users_{{ $user->id }}"
                                                    action="/panel-mfi/mfi-users/{{ $user->id }}" method="POST"
                                                    class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form form-vertical" action="/panel-mfi/mfi-users" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-6">
    ...
    <script>
        $(document).ready(function() {
            $("button[name='edit_button']").click(function() {
                ...
                $.get("/panel-mfi/mfi-users/" + edit_val + "/edit", function(data, status) {
