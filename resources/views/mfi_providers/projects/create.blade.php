    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">إنشاء مشروع</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">إنشاء مشروع</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @endif
                                <form class="form form-vertical" action="/panel-admin/projects" method="POST"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="sector_id"
                                                        ...
                                                        @foreach ($sectors as $sector)
                                                            <option value="{{ $sector->id }}"@selected($sector->id == old('sector_id'))>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status"
                                                        ...
                                                        <option value="">إختار</option>
                                                        <option value="running"@selected(old('status') == 'running')>يعمل</option>
                                                        <option value="not_working"@selected(old('status') == 'not_working')>توقف
                                                        </option>
                                                        <option value="no_start_yet"@selected(old('status') == 'no_start_yet')>لم يبدأ بعد
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('fund_amount_need_sdg') }}" required>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="first-name-vertical">معلومات المشروع</label>
                                                    <textarea name="desc" class="ckeditor form-control @error('desc') is-invalid @enderror" required>{{ old('desc') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="first-name-vertical">الأحتياجات</label>
                                                    <textarea name="need" class="ckeditor form-control @error('need') is-invalid @enderror" required>{{ old('need') }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="notes" class=" ckeditor form-control @error('notes') is-invalid @enderror" required>{{ old('notes') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <hr>
