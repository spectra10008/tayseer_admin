            ...
            @endif
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="/panel-mfi/loans/{{ $loan->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select name="request_id" class="form-control @error('request_id') is-invalid @enderror" id="" required>
                                                    ...
                                                    <option value="{{$form_request->id}}" @selected($form_request->id == old('request_id',$loan->request_id))>{{$form_request->form_request_id}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
