    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0"> التجار </h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/panel-admin/vendors/create" class="btn btn-primary">إضافة </a>
                </div>
                                ...
                                <tbody>
                                    @foreach ($vendors as $key => $vendor)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/panel-admin/vendors/{{$vendor->id}}" class="btn btn-info">
