...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">تعديل تاجر</h2>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">تعديل تاجر</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form form-vertical" action="/panel-admin/vendors/{{$vendor->id}}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="name" placeholder="اسم التاجر" value="{{ old('name',$vendor->name) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email"
                                                    ...
                                                    name="email" placeholder="البريد الألكتروني" value="{{ old('email',$vendor->email) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="phone" placeholder="رقم الهاتف" value="{{ old('phone',$vendor->phone) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="address" placeholder="العنوان" value="{{ old('address',$vendor->address) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="sale_info" class="form-control ckeditor">{{old('sale_info',$vendor->sale_info)}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <hr>
                                        </div>
                                        @php( $locations = explode(',',$vendor->location))
                                        <div class="col-4">
                                            <div class="form-group">
