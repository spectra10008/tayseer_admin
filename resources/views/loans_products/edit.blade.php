            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="/panel-admin/loans-products/{{$loanProduct->id}}" method="POST">
                                @csrf
                                @method('PATCH')
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('product_name',$loanProduct->product_name) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="first-name-vertical">وصف المنتج</label>
                                                <textarea name="product_desc" class="ckeditor form-control @error('product_desc') is-invalid @enderror" required>{{ old('product_desc',$loanProduct->product_desc) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="product_requirments" class="ckeditor form-control @error('product_requirments') is-invalid @enderror"
                                                    required>{{ old('product_requirments',$loanProduct->product_requirments) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
