    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">إنشاء مؤسسة تمويل</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">إنشاء مؤسسة تمويل</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @endif
                                <form class="form form-vertical" action="/panel-admin/mfis" method="POST"
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file"
                                                        ...
                                                        name="profile_pic" required value="{{ old('profile_pic') }}">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
