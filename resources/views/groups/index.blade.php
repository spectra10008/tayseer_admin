    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0"> المجموعات </h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/panel-admin/groups/create" class="btn btn-primary">إضافة </a>
                </div>
                            ...
                            <table class="table zero-configuration">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>اسم المجموعة</th>
                                        <th>عدد افراد المجموعة</th>
                                        <th>العنوان</th>
                                        <th>رقم التواصل</th>
                                        <th>مسجلة ؟</th>
                                        <th>اسم قائد المجموعة</th>
                                        <th>خياراتي</th>
                                    </tr>
                                </thead>
                                <tbody>
