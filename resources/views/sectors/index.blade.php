@extends('layouts.app')
@section('title', 'قطاعات التمويل')
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0"> قطاعات التمويل</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">قطاعات التمويل</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-success" name="edit_button"
                                                    value="{{ $sector->id }}" data-toggle="modal"
                                                    data-target="#edit_modal"><i class="fa fa-edit"></i></button>
                                                <button class="btn btn-danger mr-2"
                                                    onclick="if(confirm('هل أنت متأكد ؟')){document.getElementById('delete-users_{{ $sector->id }}').submit();}else{
                                            event.preventDefault();}"><i
                                                        class="fa fa-trash"></i></button>
                                                <form id="delete-users_{{ $sector->id }}"
                                                    action="/panel-admin/sectors/{{ $sector->id }}" method="POST"
                                                    class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
