    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="/panel-admin/dashboard">
                        <img src="{{ asset('/img/s.png') }}" alt="" width="180px">
                    </a></li>
        ...
        <div class="main-menu-content" style="margin-top: 10px">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item {{ request()->is('panel-admin/vendors') ? 'active' : '' }}"><a
                ...
                <li class="nav-item {{ request()->is('panel-admin/loans-products') ? 'active' : '' }}"><a
                        href="/panel-admin/loans-products"><i class="fa fa-ticket"></i><span class="menu-title"
                            data-i18n="Email">منتجات التمويل</span></a>
                </li>
                {{-- <li class="nav-item {{ request()->is('panel-admin/banks') ? 'active' : '' }}"><a
                        href="/panel-admin/banks"><i class="fa fa-building-o"></i><span class="menu-title"
                            data-i18n="Email">البنوك</span></a>
                </li> --}}
                <li class="nav-item {{ request()->is('panel-admin/group-register-types') ? 'active' : '' }}"><a
                        href="/panel-admin/group-register-types"><i class="fa fa-th"></i><span class="menu-title"
                            data-i18n="Email">انواع المجموعات</span></a>
                </li>
                <li class="nav-item {{ request()->is('panel-admin/fund-types') ? 'active' : '' }}"><a
                        href="/panel-admin/fund-types"><i class="fa fa-cubes"></i><span class="menu-title"
                            data-i18n="Email">انواع التمويل</span></a>
                </li>
                <li class="nav-item {{ request()->is('panel-admin/sectors') ? 'active' : '' }}"><a
                        href="/panel-admin/sectors"><i class="fa fa-sitemap"></i><span class="menu-title"
                            data-i18n="Email">قطاعات التمويل</span></a>
                </li>
                <li class="nav-item {{ request()->is('panel-admin/social-situations') ? 'active' : '' }}"><a
