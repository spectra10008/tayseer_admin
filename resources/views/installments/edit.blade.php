            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        @endif
                        <form class="form form-vertical" action="/panel-admin/installments/{{ $installment->id }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" name="loan_id" required>
                                                ...
                                                @foreach ($loans as $loan)
                                                    <option value="{{ $loan->id }}"@selected($loan->id == old('loan_id',$installment->loan_id))>
                                                        {{ $loan->loan_no }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" name="mfi_provider_id" required>
                                                <option value="">إختار</option>
                                                @foreach ($mfis as $mfi)
                                                    <option value="{{ $mfi->id }}"@selected($mfi->id == old('mfi_provider_id',$installment->mfi_provider_id))>
                                                        {{ $mfi->name_ar }}</option>
                                                @endforeach
                                            </select>
                                        </div>
