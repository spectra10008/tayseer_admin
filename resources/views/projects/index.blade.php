        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/panel-admin/projects/create" class="btn btn-primary">إضافة </a>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar mr-1 avatar-xl">
                                                    <img src="{{ asset('storage/'.$img) }}" alt="avtar img holder"
                                                        style="object-fit: cover">
                                                </div>
                                            </td>
                                            <td>{{ $project->project_name }}</td>
                                            <td>{{ $project->sector->sector_desc }}</td>
                                            ...
                                            <td>
                                                <a href="/panel-admin/projects/{{$project->id}}" class="btn btn-info">
