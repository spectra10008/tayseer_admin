                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="notes" class=" ckeditor form-control @error('notes') is-invalid @enderror" required>{{ old('notes', $project->notes) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <hr>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="latitude" id="latitude" readonly
                                                        class="form-control" value="{{ old('latitude', $locations[0]) }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="longitude" id="longitude" readonly
                                                        class="form-control" value="{{ old('longitude', $locations[0]) }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-12">
