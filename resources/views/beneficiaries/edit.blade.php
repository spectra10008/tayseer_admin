@extends('layouts.app')
@section('title', 'تعديل بيانات مستفيد')
@section('content')
<style>
    #map_canvas {
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">تعديل بيانات مستفيد</h2>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">تعديل بيانات مستفيد</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form form-vertical" action="/panel-admin/beneficiaries/{{$beneficiary->id}}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="اسم مستفيد" value="{{ old('name',$beneficiary->name) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="phone" placeholder="رقم الهاتف" value="{{ old('phone',$beneficiary->phone) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('age') is-invalid @enderror" name="age" placeholder="العمر" value="{{ old('age',$beneficiary->age) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('id_number') is-invalid @enderror" name="id_number" placeholder="الرقم الوطني" value="{{ old('id_number',$beneficiary->id_number) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select name="social_situation_id" class="form-control @error('social_situation_id') is-invalid @enderror" required>
                                                    ...
                                                    <option value="{{$status->id}}"@selected($status->id == old('social_situation_id',$beneficiary->social_situation_id))>{{$status->situation_desc}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('children_no') is-invalid @enderror" name="children_no" placeholder="عدد الأولاد" value="{{ old('children_no',$beneficiary->children_no) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" placeholder="العنوان" value="{{ old('address',$beneficiary->address) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_bank_account" class="form-control @error('is_bank_account') is-invalid @enderror" required>
                                                    <option value="">إختار</option>
                                                    <option value="0" @selected(old('is_bank_account',$beneficiary->is_bank_account) == 0)>لا</option>
                                                    <option value="1" @selected(old('is_bank_account',$beneficiary->is_bank_account) == 1)>نعم</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-4 bank_id d-none">
                                            <div class="form-group">
                                                ...
                                                <select name="bank_id" class="form-control @error('bank_id') is-invalid @enderror">
                                                    ...
                                                    <option value="{{$bank->id}}" @selected(old('bank_id',$beneficiary->bank_id) == $bank->id)>{{$bank->bank_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-4 branch_name d-none">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('branch_name') is-invalid @enderror" name="branch_name" placeholder="اسم الفرع" value="{{ old('branch_name',$beneficiary->branch_name) }}">
                                            </div>
                                        </div>
                                        <div class="col-4 account_no d-none">
                                            <div class="form-group">
                                                <label for="first-name-vertical">رقم الحساب</label>
                                                <input type="number" class="form-control @error('account_no') is-invalid @enderror" name="account_no" placeholder="رقم الحساب" value="{{ old('account_no',$beneficiary->account_no) }}">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <hr>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="file"
                                                    ...
                                                    name="id_image" value="{{old('id_image')}}">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <hr>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="autocomplete" id="autocomplete"
                                                    class="form-control" placeholder="الموقع" value="{{old('autocomplete',$beneficiary->address)}}">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
...
@section('scriptjs')
    ...
    <?php $old_is_bank = $beneficiary->is_bank_account; ?>
    <script>
        $(document).ready(function(){
