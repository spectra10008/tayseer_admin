                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="name" placeholder="اسم مستفيد" value="{{ old('name') }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email"
                                                        ...
                                                        name="email" placeholder="البريد الألكتروني"
                                                        value="{{ old('email') }}">
                                                </div>
                                            </div>
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        name="age" placeholder="العمر" value="{{ old('age') }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="social_situation_id"
                                                        class="form-control @error('social_situation_id') is-invalid @enderror"
                                                        required>
                                                        <option value="">إختار</option>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="is_bank_account"
                                                        class="form-control @error('is_bank_account') is-invalid @enderror"
                                                        required>
                                                        <option value="">إختار</option>
                                                    ...
                                                    <select name="bank_id"
                                                        ...
                                                        @foreach ($banks as $bank)
                                                            <option value="{{ $bank->id }}"
                                                                @selected(old('bank_id') == $bank->id)>{{ $bank->bank_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
