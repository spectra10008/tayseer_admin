...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <table class="ml-0 ml-sm-0 ml-lg-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-info">{{$formRequest->status->status_desc}}</span>
                                            @elseif($formRequest->status_id == 2)
                                            <span class="badge badge-primary">
                                                {{$formRequest->status->status_desc}}</span>
                                            @elseif($formRequest->status_id == 3)
                                            <span class="badge badge-success">{{$formRequest->status->status_desc}}</span>
                                            @elseif($formRequest->status_id == 4)
                                            <span class="badge badge-danger">{{$formRequest->status->status_desc}}</span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-12 mt-2">
                                <a href="app-user-edit.html" class="btn btn-success mr-1" data-toggle="modal" data-target="#approved"><i class="fa fa-check"></i> موافقة</a>
                                <button class="btn btn-outline-danger" data-toggle="modal" data-target="#reject"><i class="fa fa-times-circle"></i> رفض</button>
                            </div>
                            @endif
                        </div>
                    </div>
                            ...
                            @if($formRequest->files->count() != 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/panel-admin/delete-form-requets-file/{{ $file->id }}" onclick="if(!confirm('هل أنت متأكد ؟')){event.preventDefault();}" class="btn btn-danger"> <i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                                @endforeach
                            @endif
    ...
    <div class="modal fade text-left" id="approved" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form form-vertical" action="/panel-admin/form-requets/approved" method="POST">
                        @csrf
